...
export const ComposeTrigger = ({
  ...
  return (
    <div
      ...
      className="flex items-center gap-x-3 py-3 px-4 bg-white border border-slate-200 rounded-2xl cursor-text hover:bg-slate-50 transition-colors shadow-sm"
    >
