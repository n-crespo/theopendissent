      ...
      {platforms.map((platform) => (
        ...
        >
          <img
            src={platform.img}
            alt={platform.name}
            className={`h-6 w-6 object-contain transition-all duration-300 ease-in-out ${platform.brandColor}`}
          />
        </a>
      ))}
    </div>
