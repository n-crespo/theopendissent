...
export const Chip = ({
  ...
  const baseStyles =
    "shadow-sm group inline-flex items-center gap-3 rounded-full border py-1.5 pl-1.5 pr-4 transition-all duration-300 cursor-pointer active:scale-95 overflow-visible";
